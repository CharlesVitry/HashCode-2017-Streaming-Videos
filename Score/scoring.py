...
#Repertoires d'instances
Instances = "Instances_de_Test/"

#Repertoire de resultats d'heuristiques
Resultats = "Resultat_Heuristiques/"
...
listResults.append(score(Instances + "me_at_the_zoo.in", Resultats + "me_at_the_zoo.out"))
listResults.append(score(Instances + "trending_today.in", Resultats + "trending_today.out"))
listResults.append(score(Instances + "videos_worth_spreading.in", Resultats + "videos_worth_spreading.out"))
